...
$updatePassword = function (Logout $logout) {
    try {
    ...
    Session::flash('status', __('Your password has been updated, please log in again.'));
...
<section>
    ...
    <form wire:submit="updatePassword" class="flex flex-col mt-6">
        <x-form-row>
